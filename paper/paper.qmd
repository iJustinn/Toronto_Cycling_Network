...
Urban cycling has become an increasingly vital component of sustainable transportation strategies in many cities, including Toronto. As the city grows and urban congestion intensifies, promoting active transportation options such as cycling is essential for reducing emissions, improving public health, and enhancing mobility. Toronto's efforts to develop a comprehensive cycling infrastructure began in the early 2000s, resulting in a network of bike lanes, multi-use trails, and shared roadways designed to support cyclists across the city.

This paper aims to analyze the trends in Toronto’s cycling infrastructure, focusing on the patterns of bikeway installations, upgrades, and the classification of bike lanes by comfort level. Using data from the 'Cycling Network' dataset provided by Open Data Toronto, which will be discussed in detail at @sec-data. The study covers the evolution of cycling infrastructure over the past two decades, highlighting both progress and challenges. Additionally, the geographic distribution of bike lanes across the city is examined to identify areas with potential for further development.

The remainder of this paper is structured as follows: the data sources and methodologies are presented in @sec-data, followed by an analysis of the results in @sec-res, and a discussion of the findings in @sec-dis.
